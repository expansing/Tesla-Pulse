...
COMMANDS = {
    ...
    "open_tonneau": "actuate_trunk",
    "close_tonneau": "actuate_trunk",
    ...
    "steering_cooler": "remote_steering_wheel_cooler_request",
...
COMMAND_BODIES = {
    ...
    "open_tonneau": {"which_trunk": "rear", "open": True},
    "close_tonneau": {"which_trunk": "rear", "open": False},
    "light_show": {"action": "light_show"},
    "boombox": {"action": "fart"},
    "homelink": {"lat": 0, "lon": 0},
    "preconditioning_max": {"on": True, "max": True},
    "preconditioning_max_off": {"on": False, "max": True},
    # Missing command bodies
    ...
    "erase_user_data": {},
    "guest_mode": {},
    "navigation_gps_request": {"latitude": 0, "longitude": 0, "order": 1},
    "navigation_sc_request": {"supercharger_id": ""},
    ...
    "remote_auto_seat_climate_request": {"seat": "left", "enable": True},
    "remote_auto_steering_wheel_heat_climate_request": {"enable": True},
    "remote_steering_wheel_heat_level_request": {"level": 1},
    "remove_charge_schedule": {"schedule_id": ""},
    "remove_precondition_schedule": {"schedule_id": ""},
    "reset_pin_to_drive_pin": {},
    "reset_valet_pin": {},
    "schedule_software_update": {"offset_sec": 0},
    "set_bioweapon_mode": {"on": True},
    "set_cabin_overheat_protection": {"mode": "On"},
    "set_climate_keeper_mode": {"mode": 1},
    "set_cop_temp": {"level": 1},
    "set_pin_to_drive": {"pin": "0000"},
    "set_scheduled_departure": {"departure_time": 420, "end_off_peak_time": 480},
